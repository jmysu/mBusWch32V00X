...
// ===================================================================================
#ifndef PIN_NEO
  #define PIN_NEO       PC3   // define NeoPixel pin (PC0 - PC4 recommended)
#endif

#ifndef NEO_COUNT
  #define NEO_COUNT     3     // total number of pixels in the string
#endif
...
#define NEO_latch()     Delay_Us(NEO_LATCH_TIME)
